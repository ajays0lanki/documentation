...
.. tip::
   ...
   - Click :icon:`fa-thumb-tack` (pin) at the top of the :guilabel:`Filters` panel to allow another
     panel, such as the :guilabel:`Filter properties` panel, to open beside it.
